<?php
    ...
    define('LANG_CP_SEOMETA_ITEM_HINT',         'Use the item field, inserting their names in braces. For example: <strong>{title}</strong>. You can use the processing of values, more details in <a target="_blank" href="https://docs.instantcms.ru/en/manual/settings/seo-patterns">the documentation</a>');
