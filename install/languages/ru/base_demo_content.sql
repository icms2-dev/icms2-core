INSERT INTO `cms_content_datasets` (`id`, `ctype_id`, `name`, `title`, `ordering`, `is_visible`, `filters`, `sorting`, `index`, `groups_view`, `groups_hide`)
VALUES (10, 10, 'latest', 'Последние', 1, 1, NULL, '---\n- \n  by: date_pub\n  to: desc\n', 'date_pub', '---\n- 0\n', NULL);

INSERT INTO `cms_content_types` (`id`, `title`, `name`, `description`, `is_date_range`, `is_cats`, `is_cats_recursive`, `is_folders`, `is_in_groups`, `is_in_groups_only`, `is_comments`,
...
INSERT INTO `cms_con_news` (`id`, `title`, `content`, `slug`, `seo_keys`, `seo_desc`, `seo_title`, `tags`, `date_pub`, `date_last_modified`, `date_pub_end`, `is_pub`, `hits_count`, `user_id`,
...
INSERT INTO `cms_con_news_cats` (`id`, `parent_id`, `title`, `slug`, `slug_key`, `seo_keys`, `seo_desc`, `seo_title`, `ordering`, `ns_left`, `ns_right`, `ns_level`, `ns_differ`, `ns_ignore`)
...
INSERT INTO `cms_con_news_cats_bind` (`item_id`, `category_id`)
VALUES (1, 5),
       (2, 6),
       (3, 3),
       (4, 2),
...
INSERT INTO `cms_con_news_fields` (`id`, `ctype_id`, `name`, `title`, `hint`, `ordering`, `fieldset`, `type`, `is_in_list`, `is_in_item`, `is_in_filter`, `is_private`, `is_fixed`, `is_fixed_type`,
...
INSERT INTO `cms_con_pages` (`id`, `title`, `content`, `slug`, `seo_keys`, `seo_desc`, `seo_title`, `tags`, `date_pub`, `date_last_modified`, `date_pub_end`, `is_pub`, `hits_count`, `user_id`,
                            `parent_id`, `parent_type`, `parent_title`, `parent_url`, `is_parent_hidden`, `category_id`, `folder_id`, `is_comments_on`, `comments`, `rating`, `is_approved`,
...
INSERT INTO `cms_con_pages_cats_bind` (`item_id`, `category_id`)
VALUES (1, 1),
       (2, 1);

INSERT INTO `cms_menu_items` (`id`, `menu_id`, `parent_id`, `title`, `url`, `ordering`, `options`, `groups_view`, `groups_hide`)
VALUES (18, 1, 0, 'О проекте', 'pages/about.html', 1, '---\nclass: \n', '---\n- 0\n', NULL),
       (19, 1, 0, 'Правила сайта', 'pages/rules.html', 2, '---\nclass: \n', '---\n- 0\n', NULL),
       (40, 1, 0, 'Новости', '{content:news}', 1, '---\ntarget: _self\nclass:', '---\n- 0\n', NULL);


INSERT INTO `cms_perms_users` (`rule_id`, `group_id`, `subject`, `value`)
VALUES (1, 4, 'news', 'yes'),
       (1, 5, 'news', 'yes'),
       (1, 6, 'news', 'yes'),
       (4, 6, 'news', '1'),
...
INSERT INTO `cms_widgets_bind`
VALUES (16, 'default', NULL, NULL, 4, 'Новости', 'Все новости | news\r\nОбсуждаемые | news-discussed\r\n{Приватные | news/from_friends}', NULL, NULL, NULL, 1, 1, NULL, '---\n- 0\n', NULL,
...
INSERT INTO `cms_widgets_pages` (`id`, `controller`, `name`, `title_const`, `title_subject`, `title`, `url_mask`, `url_mask_not`)
